...
<nav class="navbar navbar-webmaster">
    <div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar">
			...
			<li><a href="getcontactpage">Home</a></li>
		        <li><a href="getcontactpage">Contact</a></li>
				<li class="active"><a href="getresgisterpage">Register<span class="sr-only">(current)</span></a></li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Login<span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
					    
						<li><a href="getadminlogin">Admin</a></li>
						<li><a href="getcandidatelogin">Candidate</a></li>
					</ul>
				</li>
			</ul>
